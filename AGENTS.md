...
**DClaw Deploy** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8029` (FastAPI)
- **Frontend Port:** `3029` (Next.js)
- **Database:** `dclaw_deploy` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3029`
